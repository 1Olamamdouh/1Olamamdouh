...
👩‍💻 Software Engineer | Backend (.NET) & Frontend (React/Next.js) Developer  

Passionate about building efficient, scalable systems with .NET technologies and creating modern, responsive UIs with React & Next.js.  

💡 Interests:  
- Backend: .NET, C#, SQL Server, RESTful APIs  
- Frontend: React.js, Next.js, TypeScript, Tailwind CSS  
- Exploring algorithms, problem-solving, and modern technologies  
